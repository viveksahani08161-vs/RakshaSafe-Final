...
type GroupId = 'hospitals' | 'police' | 'fire' | 'teams'

const GROUP_ORDER: { id: GroupId; titleKey: 'nearby.group.hospitals' | 'nearby.group.police' | 'nearby.group.fire' | 'nearby.group.teams' }[] = [
...
/**
 * Assign a resource to a display group using only its stored/provider type.
 * Unknown or shelter-type records fall into Safety / Rescue Teams —
 * grouping never invents a category.
 */
